...
<div class="container h-70 w-50" name="formConnexion" style="margin-top: 100px; background-color: #f0f0f0;">
    <form action="/newSurfBoard" style=" justify-content: center;" enctype="multipart/form-data" method="post">
        <div class="mb-3 form-label">
            <label class="form-label" for="exampleCheck1">Nom</label>
            <input type="text" class="form-control" id="exampleCheck1" name="nom">
        </div>
        <div class="mb-3 form-label">
            <label class="form-label" for="exampleCheck2">Description</label>
            <textarea rows="20" class="form-control" name="dess" id="exampleCheck2" required> </textarea>
        </div>
        <div class="mb-3 form-label">
            <label class="form-label" for="exampleCheck3">Image à importer</label>
            <input type="file" class="form-control" name="img" id="exampleCheck3" required/>
        </div>
